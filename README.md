...
Este repositorio contiene el desarrollo del **Trabajo Práctico Nº2** de la materia *Programación Visual*.  
El objetivo es desarrollar ejercicios utilizando **JavaScript**, aplicando buenas prácticas de organización y versionado con Git y GitHub.
